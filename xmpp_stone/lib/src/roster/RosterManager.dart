...
class RosterManager {
  static final String TAG = 'RosterManager';
  ...
  /* Выблевываем событие, что приехал новый пользователь */
  void produceNewUser(Buddy buddy) {
    Log.d(TAG, 'produce new user event ${buddy}');
    _rosterController.add([buddy]);
  }
