...
const String JABBER_NOTIFY_ENDPOINT = '/jabber/notification/223/';

const String APP_FOLDER = '223';
...
const DB_SERVER = 'https://223-223.ru';
const DB_UPDATE_ENDPOINT = '/media/app_json/companies_db_helper.json';
const DB_LOGO_PATH = '/media/logos/COMPANY_ID/resized/150x150_';
...
const PRIMARY_BG_COLOR = Color(0xFFF58220);
...
// Primary Color
const kPrimaryColor = Color(0xFFF58220);
